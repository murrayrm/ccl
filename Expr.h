...
public:
  ...
  typedef enum { 
    ...
    THIS,                      // for reproduction expressions to refer to the expression itself
  ...
  Expr ( TYPE t ); // for making an expression by just setting the type (good with THIS and RANDOM)
